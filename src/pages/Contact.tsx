            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+1 (310) 555-0198<br/>+1 (310) 555-0199 (Fax)</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">inquiries@hyllahrealestate.com<br/>partners@hyllahrealestate.com</p>
                </div>
              </div>
